...
output_dir = './test_result/detr_with_segformer/2023-01-15-23-31/'
...
model_path = "./checkpoints/pano_deformable_detr/2023-02-09-23-22-B2-lr6-decay8/ckpt_model.pkl"
...
###########################################################################################
config_path = "model/model_cfg/model_detr.yml"

with open(config_path) as fp:
    cfg = yaml.safe_load(fp)

# test_loader = DatasetLoader_pano(cfg["data"], split=cfg["data"]["test_split"])
test_loader = DatasetLoader_pano_detr(cfg["data"], split=cfg["data"]["test_split"])
