...
from model.trans4pano_deformable_detr_segnext import Trans4map_deformable_detr_segnext
...
def train(rank, world_size, cfg):
    ...
    model = Trans4map_deformable_detr_segnext(cfg['model'], device)
    ...
    for epoch in range(start_epoch, cfg["training"]["train_epoch"], 1):
        ...
        for batch in trainloader:
            ...
            # print('summary_size:',rgb.size(),  proj_indices.size(),masks_inliers.size(), rgb_no_norm.size(), map_mask.size(), map_heights.size())
            ...
            # print('compare_size:',rgb.size(),  semmap_gt.size(), observed_masks.size(),semmap_pred)
            # print('semmap_pred:', semmap_pred.size(), observed_masks.dtype)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default="model/model_cfg/model_detr_segnext.yml",
