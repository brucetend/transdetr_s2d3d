...
# model_path = "./checkpoints/knowledge_top_down_mapping/8268-B4-B1-0,3/ckpt_model.pkl"

# model_path =  "./checkpoints/knowledge_top_down_mapping/35179-B4-B2/ckpt_model.pkl"
model_path = "./checkpoints/knowledge_top_down_mapping/3960/ckpt_model.pkl"

model = Trans4map_knowledge(cfg_model, device)
