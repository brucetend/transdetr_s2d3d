...
class Trans4map_knowledge_channel(nn.Module):
    def __init__(self, cfg, device, segformer_size = "b1", load_pretrained=True):
        super(Trans4map_knowledge_channel, self).__init__()
    ...
    def forward(self, rgb, proj_indices, masks_inliers, rgb_no_norm):
        ...
        return semmap, observed_masks_B, student_feature, _c_b2
