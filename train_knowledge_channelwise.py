...
from model.trans4pano_knowledge_channel import Trans4map_knowledge_channel
...
from model.loss import CriterionCWD
...
def train(rank, world_size, cfg, teacher): 
    ...
    #################################################### Setup Model ####################################################################################################
    model = Trans4map_knowledge_channel(cfg['model'], device)
    ...
    ## channel loss
    loss_channel = CriterionCWD()
    loss_channel = loss_channel.to(device=device)
    ...
    for epoch in range(start_epoch, cfg["training"]["train_epoch"], 1):
        ...
        for batch in trainloader:
            ...
            # print('fteacher:', fteacher.size()) # torch.Size([1, 64, 256, 512])
            ...
            if observed_masks.any():
                ...
                if hcl_loss_ha == True:
                    ...
                    loss2 = loss_channel(fstudent_fuse, fteacher_fuse)

                    loss = loss + loss2
                    # print('loss_loss:', loss,  loss2)
                else:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default="model/model_cfg/model_KD_channel.yml",
