...
from model.trans4pano_deformable_detr_plus import Trans4map_deformable_detr_plus
...
def train(rank, world_size, cfg):
    ...
    for epoch in range(start_epoch, cfg["training"]["train_epoch"], 1):
        ...
        for batch in trainloader:
            ...
            # print('semmap_gt_in_train:', semmap_gt.size())
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default="model/model_cfg/model_detr_plus.yml",
