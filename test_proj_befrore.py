...
model_path = "./checkpoints/model_proj_before_segformer/2023-02-08-22-04-B2-16batch/ckpt_model.pkl"
...
with torch.no_grad():
    for batch in testingloader:
        ...
        if observed_masks.any():
            ...
            # print('semmap_pred:', semmap_pred.size())  # torch.Size([1, 500, 500, 20])
